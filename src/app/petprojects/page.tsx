  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-20 sm:py-32 flex flex-col gap-16 w-full">
      <div className="flex items-center justify-between">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-accent transition-colors w-fit !no-underline">
          <ArrowLeft className="w-4 h-4" />
          Back to Headquarters
        </Link>
        <Link href="/wiki" className="text-sm text-muted-foreground hover:text-accent transition-colors !no-underline">
          Public Wiki →
        </Link>
      </div>
