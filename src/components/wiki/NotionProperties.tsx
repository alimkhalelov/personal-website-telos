...
export function NotionProperties({ meta }: NotionPropertiesProps) {
  ...
  return (
    <div className="border border-border rounded-xl bg-card/60 backdrop-blur-sm overflow-hidden text-xs transition-all">
      {/* Header with Toggle */}
      ...
      {!isHidden && (
        <div className="p-3.5 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
          {/* Version */}
          <div className="flex items-center justify-between py-1 border-b border-border/50">
            ...
            <span className="font-mono text-blue-600 dark:text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded border border-blue-500/20 text-[11px]">
          ...
          <div className="flex items-center justify-between py-1 border-b border-border/50">
            ...
            <span className="flex items-center gap-1.5 text-emerald-600 dark:text-emerald-400 text-[11px]">
              ...
              <span>CategoryRAG (Verified 0% Hallucination)</span>
            </span>
          </div>
